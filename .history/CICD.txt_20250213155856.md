...
--> Create a freestyle job with name build remotely checkbox the trigger builds remotely option & configure an build step with authentication token(aja-123) save it 
