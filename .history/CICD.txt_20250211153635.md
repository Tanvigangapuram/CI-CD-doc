...
--> Replace True with False <useSecurity>false</useSecurity> then save it access the jenkins url in browser where you will not see any login details/user details in jenkins GUI & go for the 
