...
--> Apart from the above folders there is jenkins configurational file namely config.xml(If at all changing the config.xml) first take the backup of that or cop 
