...
--> when jenkins receive a github push hook, github plugins checks to see whether the hook came from a github repository which matches the git repository defined in SCM/Git
