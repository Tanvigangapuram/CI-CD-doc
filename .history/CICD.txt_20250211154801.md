...
--> Once restarted check with admin user whether admin user has all the privileges or not then go back to config.xml file & modify use security tag from false to
