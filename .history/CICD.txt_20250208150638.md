...
--> Create more than one job (yes) then in triggers option select build after other projects are built once you checkbox that option need to pass projects to watch name the
